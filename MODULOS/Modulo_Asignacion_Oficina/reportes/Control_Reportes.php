...
class Control_Reportes{
	...
	function ReporteGeneral_AsignacionesOficinas($id_organizacion, $nombre_organizacion){
...
$html = $obj->GenerarReporte_MisOficinas($id_organizacion, $nombre_organizacion);
$pdf->writeHTMLCell($w=0, $h=0, $x='', $y='', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='center', $autopadding=true);

$pdf->Output('Reporte_MisOficinas.pdf', 'I');
}
