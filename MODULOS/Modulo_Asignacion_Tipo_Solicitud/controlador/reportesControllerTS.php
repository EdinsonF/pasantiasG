<?php
include('../modelo/SqlReportesTipoSolicitud.php');
...
class Reportes
{
	...
	function Tipo_Solicitud_General()
	{


	$obj= new SqlReportesTipoSolicitud();
