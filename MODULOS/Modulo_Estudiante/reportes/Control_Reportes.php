...
/// reporte de estudiantes segun su estatus de solicitud de usuario

function Reporte_T_Solicitud($id_institutoP,$nombre_i,$tipo_solicitud){
...
$html = $obj->GenerarReporte_Tipo_Solicitud($id_institutoP,$nombre_i,$tipo_solicitud);
...
/// reporte de estudiantes en empresas segun su tipo

function Reporte_T_Empresa($id_institutoP,$nombre_i,$tipo_empresa){
...
$html = $obj->GenerarReporte_Tipo_Empresa($id_institutoP,$nombre_i,$tipo_empresa);
$pdf->writeHTMLCell($w=0, $h=0, $x='', $y='', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='center', $autopadding=true);

$pdf->Output('Reporte_estudiantes_por_tipo_empresa.pdf', 'I');
}
