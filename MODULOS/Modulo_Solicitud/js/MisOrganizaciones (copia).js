...
$(idTabla).dataTable({
      ...
      if(idTabla!="#Resumen"){
          $(idTabla+' tbody' ).on('click','tr',function(){
              ...
              DetallesOrganizacionSeleccionada($(this).find('td').eq(6).text());
              DepartamentosdelaOrganizacionAsociada($(this).find('td').eq(6).text());
          });
      }
...
function informacion()
{
      ...
      "</strong></a></li>";
		 	contenido +="<div class="+"'tab-pane'"+" id=tab"+index+1+" >"+
                         ...
                         "<strong><center>Organizacion</center></strong></td>"+
                         "<td hidden style=display:none>"+
                         "<strong><center>Sucursal</center></strong></td>"+
                         "<td hidden style=display:none>"+
                         "<strong><center>Persona</center></strong></td>"+          //6
          				 "</tr></thead>";
			...
			contenido +="<tr   >"+
			          	...
			          	"<td><center>"+value['datos_encargado']+"</center></td>"+
