...
$estudiante->cedula=$cedula;
 $estudiante->expediente=$expediente;
   ...
   $num= pg_num_rows($result);
	if($num==null){
	   echo "<script> alert('Tutor no Registrado')</script>";
	 ...
	 while($registro=pg_fetch_array($result)){
		 ...
		 $_SESSION['expediente']= $registro['codigo'];
		 $_SESSION['especialidad']= $registro['nombre_especialidad'];

		 }//fin del while  
   			
    $result2=$usuarios->consultar_usuario($_SESSION['id_persona'] , 4);
...
$id_perfil='4';
 ...
 $usuarios->estatus=$estatus;
  ...
  if($correo==null && $telefono==null)
  {
      ...
      $num=0;   
 	  $num= $usuarios->verificar_registro_usuario($id_persona, $usuario, $contrasena, $id_usuario, $fecha, $id_instituto, $id_perfil);
      if($num==0 ) {
      	limpiar();
	   echo "<script> alert('Tutor no Registrado')</script>";
	   echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=../vista/consultar_usuario_estudiante.phtml'>";	//Envio hacia Incluir  
	  	...
	  	limpiar();
		echo "<script> alert('Tutor  Registrado')</script>";
        echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=../vista/consultar_usuario_estudiante.phtml'>";	//Envio hacia Incluir  
...
$id_perfil='4';
 ...
 $usuarios->estatus=$estatus;
   ...
   if($correo==null && $telefono==null)
  {
      ...
      if($num==0 ) {
      	limpiar();
	   echo "<script> alert('Tutor no Modificado')</script>";
	   echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=../vista/consultar_usuario_estudiante.phtml'>";	//Envio hacia Incluir  

	  }else {
	  	limpiar();
		echo "<script> alert('Tutor  Modificado')</script>";
        echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=../vista/consultar_usuario_estudiante.phtml'>";	//Envio hacia Incluir  
